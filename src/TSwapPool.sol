...
// q why here called oz and before forge library
contract TSwapPool is ERC20 {
    ...
    constructor(
        ...
        i_poolToken = IERC20(poolToken);// q what happend if is other token? ERC777
    }
    ...
    function _addLiquidityMintAndTransfer(
        ...
        _mint(msg.sender, liquidityTokensToMint); // q I think this is the last one, can be reentrancy?
    ...
    function _swap(
        ...
        swap_count++; // I think have to be personal, no global, noone want to pay extra fee
    ...
    function getPoolTokensToDepositBasedOnWeth(
        ...
        uint256 poolTokenReserves = i_poolToken.balanceOf(address(this));
        uint256 wethReserves = i_wethToken.balanceOf(address(this));
        return (wethToDeposit * poolTokenReserves) / wethReserves; // q precission loss?
    }
